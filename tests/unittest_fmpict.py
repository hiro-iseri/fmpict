...
class UnitTestFMPict(unittest.TestCase):
    ...
    def testFmPict_saveTestConditionFile(self):
    ...
    def testFmPict_notSaveTestConditionFile(self):
        fmpict.run(self._test_dir_path + 'complex_input.mm', False, False, self._work_dir_path + 'notsavecon.txt', '')
        self.assertFalse(os.path.exists(self._work_dir_path + 'notsavecon.txt'))

    def testFmPict_notRunPict(self):
        fmpict.run(self._test_dir_path + 'complex_input.mm', True, True, self._work_dir_path + 'notsavecon.txt', '')
        self.assertFalse(os.path.exists(self._work_dir_path + 'savecon.txt'))
